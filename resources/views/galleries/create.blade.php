...
@section('title', 'Upload Photo - OnlyCars')

@section('content')
<div class="min-h-screen bg-gradient-to-
    ...
    <div class="container mx-auto px-6 py-12 max-w-4xl relative z-10">
        ...
        <div class="text-center mb-16 animate-fade-in">
            <div class="inline-flex items-center space-x-3 bg-white/10 border border-white/20 rounded-full px-6 py-3 mb-8">
                ...
                <span class="text-white font-bold tracking-wider">CAPTURE MOMENT</span>
            </div>
            
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6">
                UPLOAD <span class="bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">MASTERPIECE</span>
            </h1>
            <p class="text-gray-400 text-xl max-w-3xl mx-auto">Share your automotive photography with the community and inspire fellow enthusiasts</p>
        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <div class="bg-white/5 backdrop-blur-sm border-2 border-dashed border-white/20 rounded-2xl p-16 text-center hover:border-white/40 hover:bg-white/10 transition-all duration-300 group">
                                ...
                                <input type="file" name="image_dokumentasi" accept="image/*" required
                                ...
                                <p class="text-gray-400 mt-6 font-medium text-lg">Drop your automotive masterpiece here</p>
