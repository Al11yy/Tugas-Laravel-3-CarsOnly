...
@section('title', 'Create Event - OnlyCars')
    ...
    <div class="container mx-auto px-6 py-12 max-w-4xl relative z-10">
        ...
        <div class="text-center mb-16 animate-fade-in">
            <div class="inline-flex items-center space-x-3 bg-white/10 border border-white/20 rounded-full px-6 py-3 mb-8">
                ...
                <span class="text-white font-bold tracking-wider">CREATE EXPERIENCE</span>
            </div>
            
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6">
                NEW <span class="bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">EVENT</span>
            </h1>
            <p class="text-gray-400 text-xl max-w-3xl mx-auto">Design an exclusive automotive experience that will captivate the community</p>
        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <div class="bg-white/5 backdrop-blur-sm border-2 border-dashed border-white/20 rounded-2xl p-16 text-center hover:border-white/40 hover:bg-white/10 transition-all duration-300 group">
                                ...
                                <p class="text-gray-400 mt-6 font-medium text-lg">Upload an epic poster for your event</p>
                                <p class="text-gray-500 text-sm mt-3">JPG, PNG, GIF up to 10MB</p>
                            </div>
                        </div>
                    </div>
