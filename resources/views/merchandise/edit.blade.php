...
@section('title', 'Edit Product - OnlyCars')
...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 pt-24">
    ...
    <div class="fixed inset-0 opacity-30">
        ...
        <div class="absolute bottom-1/4 right-1/4 w-80 h-80 bg-white/5 rounded-full blur-3xl animate-pulse" style="animation-delay: -4s;"></div>
    </div>
    ...
    <div class="container mx-auto px-6 py-12 max-w-4xl relative z-10">
        ...
        <div class="text-center mb-16 animate-fade-in">
            <div class="inline-flex items-center space-x-3 bg-gray-400/10 border border-gray-400/20 rounded-full px-6 py-3 mb-8">
                ...
                <span class="text-gray-300 font-bold tracking-wider">MODIFY PRODUCT</span>
            </div>
            
            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6">
                EDIT <span class="bg-gradient-to-r from-gray-300 to-gray-500 bg-clip-text text-transparent">MERCHANDISE</span>
            </h1>
            <p class="text-gray-400 text-xl max-w-3xl mx-auto">Perfect your premium automotive merchandise and enhance its appeal</p>
        </div>
        ...
        <div class="relative animate-slide-up">
            ...
            <div class="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 lg:p-12">
                ...
                <form action="{{ route('merchandise.update', $item->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <textarea name="description" rows="6" 
                                      ...
                                      class="w-full bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl px-6 py-4 text-white placeholder-gray-400 focus:border-white/50 focus:bg-white/10 focus:outline-none resize-none transition-all duration-300">{{ old('description', $item->description) }}</textarea>
                    ...
                    <div class="space-y-4">
                                ...
                                <div class="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
                                    ...
                                    <div class="relative inline-block">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-xl opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                                            <div>
                                                <span class="text-white text-sm font-semibold block">{{ $item->name }}</span>
                                                <span class="text-gray-300 text-xs">Rp {{ number_format($item->price, 0, ',', '.') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="relative">
                            <div class="bg-white/5 backdrop-blur-sm border-2 border-dashed border-white/20 rounded-2xl p-16 text-center hover:border-white/40 hover:bg-white/10 transition-all duration-300 group">
                                ...
                                <input type="file" name="image_merch" accept="image/*"
                                ...
                                <p class="text-gray-400 mt-6 font-medium text-lg">Upload new image to replace current one</p>
